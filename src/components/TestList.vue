            ...
            <div class="flex justify-center flex-col items-center">
                ...
                <div class="justify-center shadow-lg my-3 border-gray-300 border-2 p-[20px] w-full bg-blue-50 rounded-3xl">
                    <div class="flex justify-center my-3">
                        <input v-model="testId" placeholder="Вставьте код теста" type="text" name="code" id="code" class="w-2/3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
